...
class ComputeManager(manager.Manager):
    ...
    def _validate_instance_group_policy(self, context, instance,
        ...
        def _do_validation(context, instance, group_hint):
            ...
            if 'anti-affinity' not in group.policies \
                    and 'affinity' not in group.policies:
                return
    ...
    def rebuild_instance(self, context, instance, orig_image_ref, image_ref,
        ...
        with self._error_out_instance_on_exception(context, instance):
            ...
            def detach_block_devices(context, bdms, instance_uuid):
                for bdm in bdms:
                    if bdm.is_volume:
                        volume = self.volume_api.get(context, bdm.volume_id)
                        attachment = self.volume_api.get_volume_attachment(
            ...
            try:
                ...
                src_host = instance.get('host', None)
    ...
    @hooks.add_hook("cold_migrate_manager_hook")
    @wrap_exception()
    @reverts_task_state
    @wrap_instance_event
    @wrap_instance_fault
